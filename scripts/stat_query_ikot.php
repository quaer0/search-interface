<?php
	...
	$result = pg_query($dbcon, "SELECT ikot_block_name, ikot_load_date FROM ikot_load_block_stat order by id desc $sLimit");

	$sQuery = "SELECT count(*) FROM ikot_load_block_stat";
